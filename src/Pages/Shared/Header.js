          ...
          <ul className="flex items-center hidden space-x-8 lg:flex">
            {
              ...
              className="font-medium tracking-wide text-gray-600 transition-colors duration-200 hover:text-teal-accent-400">Logout</Link>
                ...
                :
                <Link  to='/login'
              className="font-medium tracking-wide text-gray-600 transition-colors duration-200 hover:text-teal-accent-400">Login</Link>
            
              }
            <li>
              <a
                href="/"
                className="inline-flex items-center justify-center btn btn-outline btn-secondary"
                aria-label="Sign up"
                title="Sign up"
              >
                Appointment
